...
class DiffNode(BaseModel):
    op: DiffOp
    # Path to this node in the composed model, e.g., ['interfaces', 'GigabitEthernet0-0-1', 'description']
    path: list[str] = []
    obj: Any | None = None  # The ConfigComponent object this diff refers to (for component-level changes)
    before: Any | None = None
    after: Any | None = None
    children: dict[str, "DiffNode"] | None = None
