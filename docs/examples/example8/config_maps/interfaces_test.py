...
interface_list = [
    ...
    {'interface': 'TwentyFiveGigE1/1/1', 'speed': None, 'module_index': 1, 'stack_index': 1, 'index': 0, '_template': 'Native', "aggregate_id": 1, "lacp_enabled":True, "lacp_mode":"active", "lacp_interval":"fast"},
    {'interface': 'TwentyFiveGigE1/1/2', 'speed': None, 'description': None, 'switchport': False, 'switchport_mode': None, 'module_index': 1, 'stack_index': 1, 'index': 1, 'enabled': True},
    {'interface': 'TwentyFiveGigE1/1/3', 'speed': None, 'description': None, 'switchport': False, 'switchport_mode': None, 'module_index': 1, 'stack_index': 1, 'index': 2, 'enabled': True},
    {'interface': 'TwentyFiveGigE1/1/4', 'speed': None, 'description': None, 'switchport': False, 'switchport_mode': None, 'module_index': 1, 'stack_index': 1, 'index': 3, 'enabled': True},
    {'interface': 'HundredGigE1/1/1', 'speed': None, 'description': None, 'switchport': False, 'switchport_mode': None, 'module_index': 1, 'stack_index': 1, 'index': 0, 'enabled': True},
    {'interface': 'HundredGigE1/1/2', 'speed': None, 'description': None, 'switchport': False, 'switchport_mode': None, 'module_index': 1, 'stack_index': 1, 'index': 1, 'enabled': True},
    {'interface': 'HundredGigE1/1/3', 'speed': None, 'description': None, 'switchport': False, 'switchport_mode': None, 'module_index': 1, 'stack_index': 1, 'index': 2, 'enabled': True},
    {'interface': 'HundredGigE1/1/4', 'speed': None, 'description': None, 'switchport': False, 'switchport_mode': None, 'module_index': 1, 'stack_index': 1, 'index': 3, 'enabled': True},
