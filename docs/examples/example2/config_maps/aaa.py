...
from acex.configuration.components.augments.cisco.cisco_aaa import (
    CiscoAaaAuthentication,
    CiscoAaaAuthorization,
    CiscoAaaAccounting,
)

# AAA method list names for referencing in other ConfigMaps
AAA_AUTH_LOGIN_LIST = "default"
AAA_AUTH_ENABLE_LIST = "default"
AAA_AUTH_DOT1X_LIST = "default"
AAA_AUTH_CONSOLE_LIST = "CONSOLE-AUTH"
AAA_AUTHZ_EXEC_LIST = "default"
AAA_AUTHZ_CONSOLE_EXEC_LIST = "CONSOLE-EXEC"
AAA_AUTHZ_CONSOLE_COMMANDS_LIST = "CONSOLE-CUSTOM-COMMAND-AUTHORIZATION-LIST"
AAA_ACCT_DEFAULT_LIST = "default"


class aaaconfig(ConfigMap):
    def compile(self, context):
        aaa_global = aaaGlobal(name="AAA_GLOBAL", enabled=True)
...
class aaaAuthConfig(ConfigMap):
    def compile(self, context):
        ...
        aaa_auth_custom_console_config = aaaAuthorizationConfig(
            name="CONSOLE-CUSTOM-COMMAND-AUTHORIZATION-LIST"
        )
        ...
        self.aaa_acct_default_config = aaa_acct_default_config
        self.aaa_default_auth_config = aaa_default_auth_config
        self.aaa_authz_default_config = aaa_authz_default_config
        self.aaa_authz_console_exec_config = aaa_authz_console_exec_config
        self.aaa_auth_custom_console_config = aaa_auth_custom_console_config
